      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
        <div className="xl:col-span-2 xl:row-start-1 xl:row-end-[-1] relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
            ...
            <p className="text-gray-500 text-xl p5-4 sm:pt-8 ">Staring At</p>
        ...
        <div className="relative">
          ...
          <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
            ...
            <p className="text-gray-500 text-xl pt-4">Starint AT</p>
            <div className="font-medium text-red-600 text-2xl sm:text-4x1 pb-8">
              $25
            </div>
